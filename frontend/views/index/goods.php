            ...
            <div class="preview fl">
                ...
                <div class="midpic">
                    <a href="<?=$model->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$model->logo?>" alt="" width="352px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
...
<?php $imgs = \backend\models\GoodsGallery::find()->where(['goods_id'=>$model->id])->all()?>
                <div class="smallpic">
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['index/remind'])?>" method="get" class="choose">
                    <ul>
                        <li>
                            <dl>
                                <dt>购买数量：</dt>
                                <dd>
                                    ...
                                    <input type="text" name="amount" value="<?=$model->stock?>" class="amount"/>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <?php $brand = \backend\models\Brand::findOne(['id'=>$model->brand_id])?>
...
<?php $content = \backend\models\GoodsIntro::findOne(['goods_id'=>$model->id])?>
                    <div class="desc mt10">
