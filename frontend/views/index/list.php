    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href=""><img src="<?php echo $mode->logo?>" alt="" /></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['index/details','id'=>$mode->id])?>"><?php echo $mode->name?></a></dt>
                        <dd><strong><?php echo $mode->shop_price?></strong></dt>
                        <dd><a href=""><em>已有<?php echo $mode->view_times?>人评价</em></a></dt>
                    </dl>
                </li>
                <?php endforeach;?>
            </ul>
