...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl>
                <dt><?php echo $model->id?>.<?php echo $model->name?> <?php echo $model->province?> <?php echo $model->city?> <?php echo $model->area?> <?php echo $model->address?> <?php echo $model->phone?> </dt>
                <dd>
                    <?=\yii\bootstrap\Html::a('修改',['address/edit','id'=>$model->id])?>
                    <a href="#" class="a" id="<?=$model->id?>">删除</a>
                    <a href="">设为默认地址</a>
                </dd>
            </dl>
            <?php endforeach;?>
...
$('.a').click(function() {
    ...
    if (confirm('确定要删除吗？')){
        ...
        $.get('delete.html',data,function(data) {
            if (data.code ==1){
//                alert(1);
                dl.remove();
            }
