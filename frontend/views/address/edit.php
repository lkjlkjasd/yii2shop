            ...
            <form action="" name="address_form" method="post">
                <ul>
                    <li>
                        ...
                        <input type="text" name="name" class="txt" value="<?php echo $model->name?>"/>
                    </li>
                    <li>
                        <label for=""><span>*</span>所在地区：</label>
                        <select id="cmbProvince" name="province">1<?php echo $model->province?></select>

                        <select id="cmbCity" name="city" value="<?php echo $model->city?>"></select>

                        <select id="cmbArea" name="area" value="<?php echo $model->area?>"></select>
                    </li>
                    <li>
                        <label for=""><span>*</span>详细地址：</label>
                        <input type="text" name="address" class="txt address" value="<?php echo $model->address?>"  />
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" name="phone" class="txt"  value="<?php echo $model->phone?>" />
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" name="default_status" class="check" />设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
<script type="text/javascript">
    addressInit('cmbProvince', 'cmbCity', 'cmbArea','cmbStreet','defaultProvince','defaultCity');
</script>
</body>
</html>